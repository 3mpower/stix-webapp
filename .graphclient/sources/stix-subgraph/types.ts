...
export namespace StixSubgraphTypes {
  ...
  export type QuerySdk = {
    /** null **/
    dncollection: InContextSdkMethod<
      Query["dncollection"],
      QuerydncollectionArgs,
      MeshContext
    >
    /** null **/
    dncollections: InContextSdkMethod<
      Query["dncollections"],
      QuerydncollectionsArgs,
      MeshContext
    >
    /** null **/
    dntoken: InContextSdkMethod<Query["dntoken"], QuerydntokenArgs, MeshContext>
    /** null **/
    dntokens: InContextSdkMethod<
      Query["dntokens"],
      QuerydntokensArgs,
      MeshContext
    >
  ...
  export type SubscriptionSdk = {
    /** null **/
    dncollection: InContextSdkMethod<
      Subscription["dncollection"],
      SubscriptiondncollectionArgs,
      MeshContext
    >
    /** null **/
    dncollections: InContextSdkMethod<
      Subscription["dncollections"],
      SubscriptiondncollectionsArgs,
      MeshContext
    >
    /** null **/
    dntoken: InContextSdkMethod<
      Subscription["dntoken"],
      SubscriptiondntokenArgs,
      MeshContext
    >
    /** null **/
    dntokens: InContextSdkMethod<
      Subscription["dntokens"],
      SubscriptiondntokensArgs,
      MeshContext
    >
    /** null **/
