...
export type User_orderBy = "id" | "ownedCollections" | "ownedTokens"
...
export type DNCollectionResolvers<
  ContextType = MeshContext,
  ParentType extends ResolversParentTypes["DNCollection"] = ResolversParentTypes["DNCollection"]
> = ResolversObject<{
  ...
  tokens?: Resolver<
    Array<ResolversTypes["DNToken"]>,
    ParentType,
    ContextType,
    RequireFields<DNCollectiontokensArgs, "skip" | "first">
  >
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}>

export type DNTokenResolvers<
  ContextType = MeshContext,
  ParentType extends ResolversParentTypes["DNToken"] = ResolversParentTypes["DNToken"]
> = ResolversObject<{
...
> = ResolversObject<{
  dncollection?: Resolver<
    Maybe<ResolversTypes["DNCollection"]>,
    ParentType,
    ContextType,
    RequireFields<QuerydncollectionArgs, "id" | "subgraphError">
  >
  dncollections?: Resolver<
    Array<ResolversTypes["DNCollection"]>,
    ParentType,
    ContextType,
    RequireFields<QuerydncollectionsArgs, "skip" | "first" | "subgraphError">
  >
  dntoken?: Resolver<
    Maybe<ResolversTypes["DNToken"]>,
    ParentType,
    ContextType,
    RequireFields<QuerydntokenArgs, "id" | "subgraphError">
  >
  dntokens?: Resolver<
    Array<ResolversTypes["DNToken"]>,
    ParentType,
    ContextType,
    RequireFields<QuerydntokensArgs, "skip" | "first" | "subgraphError">
  >
  user?: Resolver<
...
> = ResolversObject<{
  dncollection?: SubscriptionResolver<
    Maybe<ResolversTypes["DNCollection"]>,
    "dncollection",
    ParentType,
    ContextType,
    RequireFields<SubscriptiondncollectionArgs, "id" | "subgraphError">
  >
  dncollections?: SubscriptionResolver<
    Array<ResolversTypes["DNCollection"]>,
    "dncollections",
    ParentType,
    ContextType,
    RequireFields<
      SubscriptiondncollectionsArgs,
      "skip" | "first" | "subgraphError"
    >
  >
  dntoken?: SubscriptionResolver<
    Maybe<ResolversTypes["DNToken"]>,
    "dntoken",
    ParentType,
    ContextType,
    RequireFields<SubscriptiondntokenArgs, "id" | "subgraphError">
  >
  dntokens?: SubscriptionResolver<
    Array<ResolversTypes["DNToken"]>,
    "dntokens",
    ParentType,
    ContextType,
    RequireFields<SubscriptiondntokensArgs, "skip" | "first" | "subgraphError">
  >
...
> = ResolversObject<{
  id?: Resolver<ResolversTypes["Bytes"], ParentType, ContextType>
  ownedCollections?: Resolver<
    Array<ResolversTypes["DNCollection"]>,
    ParentType,
    ContextType,
    RequireFields<UserownedCollectionsArgs, "skip" | "first">
  >
  ownedTokens?: Resolver<
    Array<ResolversTypes["DNToken"]>,
    ParentType,
    ContextType,
    RequireFields<UserownedTokensArgs, "skip" | "first">
  >
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}>
...
export async function getMeshOptions(): Promise<GetMeshOptions> {
  ...
  const stixSubgraphHandler = new GraphqlHandler({
    ...
    config: {
      endpoint:
        "https://api.studio.thegraph.com/query/63752/stix-subgraph/version/latest",
    },
    baseDir,
    cache,
    pubsub,
...
export type UsrOwnedCollectionsQuery = {
  user?: Maybe<{
    ownedCollections: Array<
      Pick<DNCollection, "id" | "name"> & { tokens: Array<Pick<DNToken, "id">> }
    >
  }>
}
...
export type UsrOwnedTokensByCollectionQuery = {
  user?: Maybe<{
    ownedTokens: Array<
      Pick<DNToken, "id"> & { collection: Pick<DNCollection, "id" | "name"> }
    >
  }>
}
...
export type DnCollectionsQuery = {
  dncollections: Array<Pick<DNCollection, "id" | "name" | "symbol" | "baseURI">>
}
...
export type DnCollectionQuery = {
  dncollection?: Maybe<
    Pick<
      DNCollection,
      "id" | "name" | "symbol" | "maxSupply" | "baseURI" | "mintPrice"
...
` as unknown as DocumentNode<
  ...
  UsrOwnedCollectionsQueryVariables
>
...
` as unknown as DocumentNode<
  ...
  UsrOwnedTokensByCollectionQueryVariables
>
...
export function getSdk<C, E>(requester: Requester<C, E>) {
  return {
    UsrOwnedCollections(
      variables: UsrOwnedCollectionsQueryVariables,
      options?: C
    ): Promise<UsrOwnedCollectionsQuery> {
      return requester<
        UsrOwnedCollectionsQuery,
        UsrOwnedCollectionsQueryVariables
      >(
        ...
        variables,
        options
      ) as Promise<UsrOwnedCollectionsQuery>
    },
    UsrOwnedTokensByCollection(
      variables: UsrOwnedTokensByCollectionQueryVariables,
      options?: C
    ): Promise<UsrOwnedTokensByCollectionQuery> {
      return requester<
        UsrOwnedTokensByCollectionQuery,
        UsrOwnedTokensByCollectionQueryVariables
      >(
        ...
        variables,
        options
      ) as Promise<UsrOwnedTokensByCollectionQuery>
    },
    DnCollections(
      variables?: DnCollectionsQueryVariables,
      options?: C
    ): Promise<DnCollectionsQuery> {
      return requester<DnCollectionsQuery, DnCollectionsQueryVariables>(
        DnCollectionsDocument,
        variables,
        options
      ) as Promise<DnCollectionsQuery>
    },
    DnCollection(
      variables: DnCollectionQueryVariables,
      options?: C
    ): Promise<DnCollectionQuery> {
      return requester<DnCollectionQuery, DnCollectionQueryVariables>(
        DnCollectionDocument,
        variables,
        options
      ) as Promise<DnCollectionQuery>
    },
  }
}
